function execute(nums1: number[], m: number, nums2: number[], n: number): number[] {
  let i = m - 1 // Points the last valid element of nums1
  let j = n - 1 // Points the last element of nums2
  let k = m + n - 1 // Points the last element of nums1
